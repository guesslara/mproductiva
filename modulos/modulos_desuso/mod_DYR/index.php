...
<div id="contenedorEnsamble">
	<div id="contenedorEnsamble3">
		<div id="barraOpcionesEnsamble">
			<div class="opcionesEnsamble" onclick="clean2(); diagnostica('<?=$_SESSION[$txtApp['session']['idProyectoSeleccionado']];?>','<?=$_SESSION[$txtApp['session']['idUsuario']];?>','Diagnosticar')" title="Diagnostico">Diagnostico</div>
			<div class="opcionesEnsamble" onclick="cleand2();repara('<?=$_SESSION[$txtApp['session']['idProyectoSeleccionado']];?>','<?=$_SESSION[$txtApp['session']['idUsuario']];?>','Reparar')" title="Reparación">Reparacion</div>
...
<div id="ventanaDialogo1" class="ventanaDialogo" style="display:none;">
	<div id="barraTitulo1VentanaDialogo">fallas<div id="btnCerrarVentanaDialogo"><a href="#" onclick="cerrarVentana('ventanaDialogo1')" title="Cerrar Ventana Dialogo"><img src="../../img/close.gif" border="0" /></a></div></div>
	<div id="msgVentanaDialogo" class="msgVentanaDialogo" style="border: 0px solid #ff0000;height: 95%;overflow: auto;"></div>
</div>
<?
