...
<script type="text/javascript">
	$(document).ready(function(){
		mostrarLotes('<?=$_SESSION[$txtApp['session']['idProyectoSeleccionado']];?>');
		redimensionar();		
	});	
...
<div id="contenedorEnsamble">
	<div id="contenedorEnsamble3">
		<div id="barraOpcionesEnsamble">
			<div class="opcionesEnsamble" onclick="clean2(); mostrarLotes('<?=$_SESSION[$txtApp['session']['idProyectoSeleccionado']];?>')" title="Lotes">Inicio</div>
