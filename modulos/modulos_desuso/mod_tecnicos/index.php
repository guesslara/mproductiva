...
<div id="contenedorEnsamble">
	<div id="contenedorEnsamble3">
		<div id="barraOpcionesEnsamble">
			<div class="opcionesEnsamble" onclick="clean2(); mostrarLotes('<?=$_SESSION[$txtApp['session']['idProyectoSeleccionado']];?>','Inicio')" title="inicio">Inicio</div>
			<div class="opcionesEnsamble" onclick="clean2();mostrarLotes('<?=$_SESSION[$txtApp['session']['idProyectoSeleccionado']];?>','Asigna')" title="Asignar">Asignar</div>
			<div class="opcionesEnsamble" onclick="clean2();mostrarLotes('<?=$_SESSION[$txtApp['session']['idProyectoSeleccionado']];?>','Re-Asigna')" title="Re-Asignar">Re-Asignar</div>
			<div class="opcionesEnsamble" onclick="clean2();clean1();AB('<?=$_SESSION[$txtApp['session']['idUsuario']];?>','<?=$_SESSION[$txtApp['session']['idProyectoSeleccionado']];?>')" title="A&B">Altas/bajas</div>
